import unittest
from unittest_examples import eat, nap, is_funny, laugh


class ActivityTests(unittest.TestCase):
    def test_eat_healthy(self):
        """eat should indicate positivity for eating healthy"""
        self.assertEqual(
    ...
    def test_eat_unhealthy(self):
        """eat should indicate you're given up for eating unhealthy"""
        self.assertEqual(
